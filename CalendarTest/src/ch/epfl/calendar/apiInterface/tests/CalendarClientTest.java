...
public class CalendarClientTest extends MockTestCase {
    ...
    private static final String[] COURSE_NAMES = {"Algorithms", "Software engineering"};
    private static final int[] NUMBER_OF_PERIODS_BY_COURSES = {2, 1};
    ...
    public final void testCallback() throws NoSuchMethodException, IllegalAccessException, 
        ...
        callback.invoke(calendarClient, new Object[] {true});
