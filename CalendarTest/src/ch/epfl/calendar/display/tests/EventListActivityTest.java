...
//    }
//    
//    public final void testClickOnEachElement() {
//        int nbOfElementsVisible = 8;
//        for (int i = 0; i < nbOfElementsVisible; i++) {
//            onData(allOf(is(instanceOf(ListViewItem.class)), hasEntry))
//            // Every entry in the ListView is a HashMap
//                .inAdapterView(withId(R.id.list_event_view)).atPosition(i).perform(click()).check(doesNotExist());
//        }
//    }
//
