...
public class ISAXMLParserTest extends MockTestCase {
    ...
    public void setUp() throws NoSuchMethodException,
        ...
        readText = (ISAXMLParser.class).getDeclaredMethod("readText",
                new Class[] {});
        readText.setAccessible(true);
        readName = (ISAXMLParser.class).getDeclaredMethod("readName",
                new Class[] {});
        readName.setAccessible(true);
        readType = (ISAXMLParser.class).getDeclaredMethod("readType",
                new Class[] {});
        readType.setAccessible(true);
        readRoom = (ISAXMLParser.class).getDeclaredMethod("readRoom",
                new Class[] {});
        readRoom.setAccessible(true);
        readCourse = (ISAXMLParser.class).getDeclaredMethod("readCourse",
                new Class[] {});
        readCourse.setAccessible(true);
        readStudyPeriod = (ISAXMLParser.class).getDeclaredMethod(
                "readStudyPeriod", new Class[] {});
        readStudyPeriod.setAccessible(true);
        readData = (ISAXMLParser.class).getDeclaredMethod("readData",
                new Class[] {});
        readData.setAccessible(true);

        xmlEndTag = new ByteArrayInputStream(
                "<test></test><test></test>".getBytes("UTF-8"));
        standardXml = new ByteArrayInputStream(
                "<test><default>bla bla</default></test>".getBytes("UTF-8"));
        standardReadName = new ByteArrayInputStream(
                "<name><text>bla bla</text></name>".getBytes("UTF-8"));
        standardReadNameOther = new ByteArrayInputStream(
                "<name><other>bla bla</other></name>".getBytes("UTF-8"));
        standardReadType = new ByteArrayInputStream(
                "<type><text>bla bla</text></type>".getBytes("UTF-8"));
        standardReadTypeOther = new ByteArrayInputStream(
                "<type><other>bla bla</other></type>".getBytes("UTF-8"));
        standardReadRoom = new ByteArrayInputStream(
                "<room><name><text>bla bla</text></name></room>"
                        .getBytes("UTF-8"));
        standardReadRoomOther = new ByteArrayInputStream(
                "<room><other>bla bla</other></room>".getBytes("UTF-8"));
        standardReadCourse = new ByteArrayInputStream(
                "<course><name><text>bla bla</text></name></course>"
                        .getBytes("UTF-8"));
        standardReadCourseOther = new ByteArrayInputStream(
                "<course><other>bla bla</other></course>".getBytes("UTF-8"));
        standardReadStudyPeriod = new ByteArrayInputStream(
                ("<study-period><id>1808047617</id><date>13.10.2014</date>"
        ...
        standardReadStudyPeriodNullWithDates = new ByteArrayInputStream(
                ("<study-period>"
                        + "<date>13.10.2014</date><startTime>14:15</startTime>"
                        + "<endTime>16:00</endTime></study-period>")
                        .getBytes("UTF-8"));
        standardReadStudyPeriodNullWithWrongDate = new ByteArrayInputStream(
                ("<study-period>"
                        + "<date>13.10.2014.14</date><startTime>14:15</startTime>"
                        + "<endTime>16:00</endTime></study-period>")
                        .getBytes("UTF-8"));
        standardReadStudyPeriodNullWithWrongHour = new ByteArrayInputStream(
                ("<study-period>"
                        + "<date>13.10.2014</date><startTime>14:15:16</startTime>"
                        + "<endTime>16:00</endTime></study-period>")
                        .getBytes("UTF-8"));
        standardReadStudyPeriodNull = new ByteArrayInputStream(
                "<study-period></study-period>".getBytes("UTF-8"));
        standardReadData = new ByteArrayInputStream(
                ("<data><study-period><id>1808047617</id><date>13.10.2014</date>"
                        + "<duration>105</duration><day>1</day><startTime>14:15</startTime><endTime>16:00</endTime>"
                        + "<type><text lang=\"en\">Lecture</text><text lang=\"fr\">Cours</text></type> "
                        + "+ <course><id>2258712</id><name><text lang=\"fr\">Algorithms</text></name></course>"
                        + "<room><id>2192131</id><code>CO2</code><name><text lang=\"fr\">CO 2</text>"
                        + "</name></room></study-period></data>")
                        .getBytes("UTF-8"));
        standardReadDataNull = new ByteArrayInputStream(
                "<data></data>".getBytes("UTF-8"));
        standardInput = new ByteArrayInputStream(
                ("<data status=\"Termine\" date=\"20141017 16:08:36\""
    ...
    public void testParseWithExceptions() throws IOException,
        ...
        try {
            ...
            if (e.getMessage()
                    .equals("IO Error during XML Parsing (nextTag())")) {
                // Waited exception
            } else {
                fail();
            }
    ...
    public void testParseWithCorrectInput() {
        ...
        for (Course course : courses) {
            if (course.getName().equals("Algorithms")) {
                assertEquals("1808047617", course.getPeriods().get(0).getId());
            }
        }
    }

    public void testReadData() throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException,
            ParsingException, XmlPullParserException, IOException {
        ...
        try {
            ...
            List<Course> courses = (List<Course>) readData.invoke(
                    new ISAXMLParser(parser), new Object[] {});
        ...
        // XmlPullParserException
        XmlPullParser mockParser = Mockito.mock(XmlPullParser.class);
        Mockito.doThrow(new XmlPullParserException("ERROR")).when(mockParser)
                .next();
        ...
        try {
            ...
            if (e.getTargetException() instanceof ParsingException) {
                if (e.getTargetException().getMessage()
                        .equals("Parsing Error during XML Parsing")) {
                    // waited exception
                } else {
                    fail();
                }
        ...
        try {
            ...
            if (e.getTargetException() instanceof ParsingException) {
                if (e.getTargetException().getMessage()
                        .equals("IO Error during XML Parsing")) {
                    // waited exception
                } else {
                    fail();
                }
    ...
    public void testReadStudyPeriod() throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException,
        ...
        try {
            ...
            if (e.getTargetException() instanceof NullPointerException) {
                if (e.getTargetException().getMessage()
                        .equals("Date or Hour is null in createCalendar()")) {
                    // waited exception
                } else {
        ...
        try {
            ...
            parser.nextTag();
            Course course = (Course) readStudyPeriod.invoke(new ISAXMLParser(
                    parser), new Object[] {});
        ...
        try {
            ...
            assertEquals(new GregorianCalendar(YEAR, MONTH, DAY, HOUR_FOURTEEN,
                    MINUTE_FIFTEEN), course.getPeriods().get(0).getStartDate());
            assertEquals(new GregorianCalendar(YEAR, MONTH, DAY, HOUR_SIXTEEN,
                    MINUTE_ZERO), course.getPeriods().get(0).getEndDate());
            assertEquals(PeriodType.LECTURE, course.getPeriods().get(0)
                    .getType());
            assertNotNull(course.getPeriods().get(0).getRooms());
    ...
    public void testReadCourse() throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException,
            XmlPullParserException, IOException {
        XmlPullParser parser = Xml.newPullParser();
        ...
        try {
            ...
            parser.nextTag();
            assertEquals("bla bla", readCourse.invoke(new ISAXMLParser(parser),
                    new Object[] {}));
        } finally {
        }
        ...
        try {
            ...
            parser.nextTag();
            assertNull(readCourse.invoke(new ISAXMLParser(parser),
                    new Object[] {}));
        } finally {
        }
    }

    public void testReadRoom() throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException,
            XmlPullParserException, IOException {
        XmlPullParser parser = Xml.newPullParser();
        ...
        try {
            ...
            assertEquals("bla bla",
                    readRoom.invoke(new ISAXMLParser(parser), new Object[] {}));
        } finally {
        }
        ...
        try {
            ...
            parser.nextTag();
            assertNull(readRoom.invoke(new ISAXMLParser(parser),
                    new Object[] {}));
        } finally {
        }
    }

    public void testReadType() throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException,
            XmlPullParserException, IOException {
        XmlPullParser parser = Xml.newPullParser();
        ...
        try {
            ...
            parser.nextTag();
            assertEquals("bla bla",
                    readType.invoke(new ISAXMLParser(parser), new Object[] {}));
        } finally {
        }
        ...
        try {
            ...
            parser.nextTag();
            assertNull(readType.invoke(new ISAXMLParser(parser),
                    new Object[] {}));
        } finally {
        }
    }

    public void testReadName() throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException,
            XmlPullParserException, IOException {
        XmlPullParser parser = Xml.newPullParser();
        ...
        try {
            ...
            parser.nextTag();
            assertEquals("bla bla",
                    readName.invoke(new ISAXMLParser(parser), new Object[] {}));
        } finally {
        }
        ...
        try {
            ...
            parser.nextTag();
            assertNull(readName.invoke(new ISAXMLParser(parser),
                    new Object[] {}));
        } finally {
        }
    }

//    public void testReadId() throws IllegalAccessException,
//            IllegalArgumentException, XmlPullParserException, IOException,
//            InvocationTargetException {
//        XmlPullParser parser = Xml.newPullParser();
//
//        // With Null argument
//        try {
//            readId.invoke(new ISAXMLParser(), new Object[] {});
//            fail("readId : Fail test null pointer");
//        } catch (InvocationTargetException e) {
//            if (e.getTargetException() instanceof NullPointerException) {
//                if (e.getTargetException().getMessage()
//                        .equals("Parser is null")) {
//                    // waited exception
//                } else {
//                    fail("readId wrong NullPointerException");
//                }
//            }
//        }
//
...
//        try {
//            parser.setFeature(XmlPullParser.FEATURE_PROCESS_NAMESPACES, false);
//            parser.setInput(standardReadId, null);
//            parser.nextTag();
//            assertEquals("1808047755",
//                    readId.invoke(new ISAXMLParser(parser), new Object[] {}));
//        } finally {
//        }
//
//        // unexpected tags
//        try {
//            parser.setFeature(XmlPullParser.FEATURE_PROCESS_NAMESPACES, false);
//            parser.setInput(standardReadIdOther, null);
//            parser.nextTag();
//            assertNull(readId.invoke(new ISAXMLParser(parser), new Object[] {}));
//        } finally {
//        }
//    }

    public void testReadText() throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException,
            XmlPullParserException, IOException {
        XmlPullParser parser = Xml.newPullParser();
        ...
        try {
            ...
            parser.nextTag();
            assertNull(readText.invoke(new ISAXMLParser(parser),
                    new Object[] {}));
        } finally {
        }
        ...
        try {
            ...
            parser.nextTag();
            assertEquals("bla",
                    readText.invoke(new ISAXMLParser(parser), new Object[] {}));
        } finally {
        }
    }

    public void testSkip() throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException,
            XmlPullParserException, IOException {
        XmlPullParser parser = Xml.newPullParser();
