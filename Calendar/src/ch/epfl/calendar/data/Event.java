...
public class Event {
    ...
    public Event(String date, String name, String startTime, String endTime,
            String type, String linkedCourse) {
        this.mName = name;
        this.mStartDate = App.getInstance().createCalendar(date, startTime);
        this.mEndDate = App.getInstance().createCalendar(date, endTime);
    ...
    public String toString() {
        ...
        String startDate = App.getInstance().calendarToBasicFormatString(
                this.mStartDate);
        String endDate = App.getInstance().calendarToBasicFormatString(
                this.mEndDate);
