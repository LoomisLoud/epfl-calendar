...
public class WeekView extends View {
    ...
    private final GestureDetector.SimpleOnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
            ...
            if (mCurrentFlingDirection == Direction.HORIZONTAL) {
                mScroller.fling((int) mCurrentOrigin.x, 0, (int) velocityX, 0,
            ...
            if (mEventRects != null && mEventClickListener != null) {
                ...
                for (EventRect event : reversedEventRects) {
                    if (event.rectF != null && e.getX() > event.rectF.left
                        ...
                        mEventClickListener.onEventClick(event.event,
                                event.rectF);
            ...
            if (mEventLongPressListener != null && mEventRects != null) {
                ...
                for (EventRect event : reversedEventRects) {
                    if (event.rectF != null && e.getX() > event.rectF.left
                            ...
                            && e.getY() > event.rectF.top
                            && e.getY() < event.rectF.bottom) {
                        mEventLongPressListener.onEventLongPress(event.event,
                                event.rectF);
    ...
    private void init() {
        ...
        setmStartDate((Calendar) mToday.clone());
    ...
    private void drawTimeColumnAndAxes(Canvas canvas) {
        ...
        if (mCurrentScrollDirection == Direction.VERTICAL) {
            if (mCurrentOrigin.y - mDistanceY > 0) {
                mCurrentOrigin.y = 0;
            } else if (mCurrentOrigin.y - mDistanceY < -(mHourHeight * 24
                    + mHeaderTextHeight + mHeaderRowPadding * 2 - getHeight())) {
                mCurrentOrigin.y = -(mHourHeight * 24 + mHeaderTextHeight
        ...
        for (int i = 0; i < 24; i++) {
            ...
            // bottom-right corner.
            if (top < getHeight()) {
                canvas.drawText(getTimeString(i), mTimeTextWidth
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        for (int dayNumber = leftDaysWithGaps + 1; dayNumber <= leftDaysWithGaps
            ...
            // Draw the day labels.
            String dayLabel = String
                    .format("%s %d/%02d", getDayName(day),
     ...
     *            The text to draw.
     * @param rect
     *            The rectangle on which the text is to be drawn.
     * @param canvas
     *            The canvas to draw upon.
     * @param originalTop
     *            The original top position of the rectangle. The rectangle may
     *            have some of its portion outside of the visible area.
     * @param originalLeft
     *            The original left position of the rectangle. The rectangle may
     *            have some of its portion outside of the visible area.
     */
    ...
    /**
     * Gets more events of one/more month(s) if necessary. This method is called
     * when the user is scrolling the week view. The week view stores the events
     * of three months: the visible month, the previous month, the next month.
     * 
     * @param day
    ...
    /**
     * Calculates the left and right positions of each events. This comes handy
     * specially if events are overlapping.
     * 
     * @param eventRects
    ...
    /**
     * Expands all the events to maximum possible width. The events will try to
     * occupy maximum space available horizontally.
     * 
     * @param collisionGroup
     *            The group of events which overlap with each other.
     */
    ...
    /**
     * Set the first day of the week. First day of the week is used only when
     * the week view is first drawn. It does not of any effect after user starts
     * scrolling horizontally.
     * <p>
     * <b>Note:</b> This method will only work if the week view is set to
     * display more than 6 days at once.
     * </p>
     * 
     * @param firstDayOfWeek
     *            The supported values are {@link java.util.Calendar#SUNDAY},
     ...
     * short day names is 'M' for 'Monday' and example of long day names is
     * 'Mon' for 'Monday'.
     * 
     * @param length
    ...
    private String getDayName(Calendar date) {
        ...
        if (Calendar.MONDAY == dayOfWeek) {
            return (mDayNameLength == LENGTH_SHORT ? "M" : "MON");
        } else if (Calendar.TUESDAY == dayOfWeek) {
            return (mDayNameLength == LENGTH_SHORT ? "T" : "TUE");
        } else if (Calendar.WEDNESDAY == dayOfWeek) {
            return (mDayNameLength == LENGTH_SHORT ? "W" : "WED");
        } else if (Calendar.THURSDAY == dayOfWeek) {
            return (mDayNameLength == LENGTH_SHORT ? "T" : "THU");
        } else if (Calendar.FRIDAY == dayOfWeek) {
            return (mDayNameLength == LENGTH_SHORT ? "F" : "FRI");
        } else if (Calendar.SATURDAY == dayOfWeek) {
            return (mDayNameLength == LENGTH_SHORT ? "S" : "SAT");
        } else if (Calendar.SUNDAY == dayOfWeek) {
            return (mDayNameLength == LENGTH_SHORT ? "S" : "SUN");
        }
        return "";
    }
