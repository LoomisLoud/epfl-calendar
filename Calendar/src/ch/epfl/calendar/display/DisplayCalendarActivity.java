...
public class DisplayCalendarActivity extends Activity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.action_week_view:
            ...
            return true;
        case R.id.add_event:
            AddEventActivity addEvent = new AddEventActivity();
    ...
    public List<WeekViewEvent> onMonthChange(int newYear, int newMonth) {
        ...
        endTime.set(Calendar.MINUTE, 0);
        event = new WeekViewEvent(4, "Securité des réseaux", startTime, endTime);
    ...
    public void onEventClick(WeekViewEvent event, RectF eventRect) {
        Toast.makeText(DisplayCalendarActivity.this, "Clicked " + event.getName(),
                Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onEventLongPress(WeekViewEvent event, RectF eventRect) {
        Toast.makeText(DisplayCalendarActivity.this,
