...
public class AddEventBlockActivity extends DefaultActionBarActivity {
	...
	private void storeWeeklyEvent(Intent i) {
		...
		Calendar startEvent = createStartDateBlock(calendarDayFromArrayAdapter(mSpinnerDays.getSelectedItemPosition()),
			mStartBlockEventHour.getCurrentHour(),
			mStartBlockEventHour.getCurrentMinute());
		Calendar endEvent = createStartDateBlock(calendarDayFromArrayAdapter(mSpinnerDays.getSelectedItemPosition()),
			mEndBlockEventHour.getCurrentHour(),
			mEndBlockEventHour.getCurrentMinute());
		Calendar endDate = createEndDateBlock((Period) i.getParcelableExtra("period"));
